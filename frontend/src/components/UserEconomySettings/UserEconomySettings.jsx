		...
		<div className="">
			...
			<div>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					<div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg shadow-inner">
						...
						<input
							...
							onChange={(e) =>
								updateSettings({ has_gold_pass: e.target.checked })
							}
					...
					<div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg shadow-inner">
						...
						<input
							...
							onChange={(e) =>
								updateSettings({ builders_count: Number(e.target.value) })
							}
				...
				<div className="mt-4 text-center">
					<button onClick={refresh} className="underline text-sm text-gray-500">
						Refresh
					</button>
